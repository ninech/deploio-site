...
export const QuantInput = ({
  ...
  return (
    <div className="flex h-[48px] w-[118px] items-center justify-between gap-1 rounded-xl border border-nine-gray-200 p-1">
      <ButtonIcon
        type="button"
      ...
      <input
        type="text"
        value={value}
        className="h-[31px] w-[36px] rounded-md border border-transparent py-1 text-center font-inter-tight font-medium text-nine-primary-900 outline-none hover:border-nine-gray-200 focus:border-nine-gray-700 "
        min={0}
