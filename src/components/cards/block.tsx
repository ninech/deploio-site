...
export const Block = ({ title, segments, products }: BlockProps) => {
  ...
  return (
    <div className="rounded-xl border border-t-0 border-nine-gray-200 bg-nine-tertiary shadow-nine-card">
      ...
      <div
        className={clsx(
          "inline-flex w-full  items-center justify-between rounded-xl border-t border-nine-gray-200 bg-white px-3 py-2 font-inter-tight text-lg font-semibold text-nine-primary-900",
          {
